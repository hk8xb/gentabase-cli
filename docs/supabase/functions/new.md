...
After creating the function, you can edit it locally and then use `gentabase functions serve`  to test it before deploying with `gentabase functions deploy`.
