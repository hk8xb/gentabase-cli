...
Requires your local project to be linked to a remote database by running `gentabase link`.
...
```bash
$ gentabase migration repair 20230103054303 --status reverted
Connecting to remote database...
Repaired migration history: [20220810154537] => reverted
Finished gentabase migration repair.
