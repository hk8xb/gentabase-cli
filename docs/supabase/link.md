...
Link your local development project to a hosted Gentabase project.

PostgREST configurations are fetched from the Gentabase platform and validated against your local configuration file.
